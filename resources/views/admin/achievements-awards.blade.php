...
div.dataTables_wrapper {
   ...
   <div style="display: flex; justify-content: space-between; align-items: center; margin: 10px;">
    ...
    <a href="{{ route('add-new-achievements-awards') }}" class="btn btn-success" style="padding: 6px 12px; font-size: 14px;">
  ...
  <div style="overflow-x:auto;">
    ...
    $(document).ready(function () {
        $('#users-table').DataTable({
            ...
            scrollX: true, 
            responsive: true,
            ajax: "{{ route('get-achievements-awards') }}",
           columns: [
     {
                    data: null,
                    name: 'serial',
    ...
    {
    data: 'achievementsAwards_image',
    name: 'achievementsAwards_image',
  ...
  name: 'position',
    ...
    if (confirm("Are you sure you want to delete this post?")) {
        $.ajax({
            url: "/deleteAchievementsAwards/" + id,
            type: "DELETE",
            data: {
                _token: "{{ csrf_token() }}"
            },
