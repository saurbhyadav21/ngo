...
div.dataTables_wrapper {
   ...
   <div style="display: flex; justify-content: space-between; align-items: center; margin: 10px;">
    ...
    <a href="{{ route('add-new-about-us-post') }}" class="btn btn-success" style="padding: 6px 12px; font-size: 14px;">
        Add New About Us Post
    </a>
</div>
...
$(document).on('click', '.delete', function () {
    ...
    if (confirm("Are you sure you want to delete this About Us post?")) {
        // Laravel route with ID placeholder
        var routeTemplate = "{{ route('deleteAboutUsPost', ['id' => '__ID__']) }}";
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                alert("Error deleting About Us post.");
            }
        });
    }
});
