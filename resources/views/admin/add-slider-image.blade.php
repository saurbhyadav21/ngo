...
<div class="container mt-4 mb-5 ">
  <h4 class="mb-4 custom-margin">Add Slider Image</h4>
  @if(session('success'))
  <div class="alert alert-success mt-3">
    {{ session('success') }}
  </div>
@endif
    <form id="post-add-form" action="{{ route('create-sliderImage') }}" method="POST" enctype="multipart/form-data">
     @csrf
    ...
    <button type="submit" class="btn btn-primary mt-4 w-100">Add Slider Image</button>
  </form>
