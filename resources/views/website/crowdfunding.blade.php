...
<div class="container my-5">
    <h2 class="text-center mb-4" style="margin-top: 150px; font-weight: 800; color:rgba(0, 146, 69, 1)" >Crowdfunding</h2>
...
<div class="col-md-7 p-4 d-flex flex-column justify-content-between">
  ...
  <div class="d-flex justify-content-between mt-3">
    <a href="{{ route('participate-website-page', ['id' => $event->id]) }}"
   class="btn btn-primary mt-3">
   Participate
</a>

    <a href="{{ route('donate.php') }}"
