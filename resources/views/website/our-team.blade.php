...
<div class="container my-5">
    ...
    <div class="text-center mb-4">
        <h2 class="fw-bold" style="margin-top: 140px; color:rgba(0, 146, 69, 1)">Team Member</h2>
    </div>
...
<div class="row row-cols-1 row-cols-md-3 g-4 card_main_div">
    @include('partials.team-member-cards', ['customers' => $customers])
</div>
