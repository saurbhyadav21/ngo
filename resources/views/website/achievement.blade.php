...
<div class="container my-5">
    ...
    <div class="text-center mb-4">
        <h2 class="fw-bold" style="margin-top: 140px; color:rgba(0, 146, 69, 1)">Achievements/Awards</h2>
    </div>
...
<div class="col">
    <!-- <div class="card h-100 shadow rounded-4 p-3"> -->
        <!-- <div class="text-center"> -->
            <img src="{{ asset('storage/uploads/' . $achievement->achievementsAwards_image) }}"
                 alt="{{ $achievement->title }}"
                 width="260" height="260"
                 class="mx-auto d-block rounded mb-3 image-click  rounded-4 "
                 data-bs-toggle="modal"
                 data-bs-target="#imageModal"
                 data-image="{{ asset('storage/uploads/' . $achievement->achievementsAwards_image) }}"
                 style="cursor: pointer; object-fit: cover; box-shadow: 0 10px 25px rgba(0,0,0,0.25);">
        <!-- </div> -->
        <h5 class="text-center mb-2">{{ ucwords(strtolower($achievement->title)) }}</h5>
    <!-- </div> -->
</div>
@empty
<p class="text-center py-4 col-12">No achievement found 😕</p>
@endforelse
