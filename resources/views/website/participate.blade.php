...
<div class="container mt-4 mb-5">
    <h4 class="mb-4 text-center" style="margin-top: 140px; font-weight: 800; color:rgba(0, 146, 69, 1)">Participation Form</h4>
  ...
  <div class="alert alert-info mb-4">
        You are Participating for event ID <strong>{{ $id }}</strong>.
    </div>
    <form id="post-add-form" action="{{ route('add.participate',['event_id'=>$id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
    ...
    <div>
        ...
        <div class="mb-3">
            <label class="form-label">Want To Donate: <span class="dot">*</span></label>
            <textarea class="form-control" name="want_to_donate" rows="3" required></textarea>
        </div>
